...
follow = {
    "ADDOP": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    ...
    "RELOP": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    ...
    "MULTOP": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    "SIGN": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    "START": set(),
    "PROG": set(),
    ...
    "ASSIGNOP": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    "EXPR": {TokenType.COMMA, TokenType.CLOSEPAR, TokenType.SEMI},
    "STATEMENT4": {TokenType.ELSE, TokenType.SEMI, TokenType.LET, TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN, TokenType.CLOSECUBR},
    "ID": {TokenType.MULT, TokenType.DIV, TokenType.AND, TokenType.ID, TokenType.OPENPAR, TokenType.DOT, TokenType.OPENSQBR, TokenType.EQ, TokenType.CLOSESQBR, TokenType.EQ, TokenType.NOTEQ, TokenType.LT, TokenType.GT, TokenType.LEQ, TokenType.GEQ, TokenType.PLUS, TokenType.MINUS, TokenType.OR, TokenType.COMMA, TokenType.CLOSEPAR, TokenType.SEMI},
    "STATEMENT2": {TokenType.ELSE, TokenType.SEMI, TokenType.LET, TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN, TokenType.CLOSECUBR},
    ...
    "VARDECLORSTAT": {TokenType.LET, TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN, TokenType.CLOSECUBR},
    "VARDECL": {TokenType.PUBLIC, TokenType.PRIVATE, TokenType.LET, TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN, TokenType.CLOSECUBR},
...
first = {
    ...
    "ARITHEXPR": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    ...
    "REPTFUNCBODY1": {TokenType.LET, TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN},
    ...
    "REPTSTATBLOCK1": {TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN},
    "RELEXPR": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    "STATBLOCK": {TokenType.OPENCUBR, TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN},
    "STATEMENT3": {TokenType.DOT, TokenType.EQ},
    "ASSIGNOP": {TokenType.EQ},
    "EXPR": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    ...
    "TERM": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    "FACTOR": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
    ...
    "VARDECLORSTAT": {TokenType.LET, TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN},
    "VARDECL": {TokenType.LET},
    "STATEMENT": {TokenType.IF, TokenType.WHILE, TokenType.READ, TokenType.WRITE, TokenType.RETURN},
    ...
    "APARAMS": {TokenType.INTNUM, TokenType.FLOATNUM, TokenType.OPENPAR, TokenType.NOT, TokenType.PLUS, TokenType.MINUS},
